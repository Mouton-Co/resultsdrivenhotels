<div class="flex w-full items-center justify-center bg-[#f7f5f5]">
    <div class="flex w-full max-w-[1200px] flex-col items-center justify-center py-12 sm:py-24">
        <h1 class="text-wrap sm:text-nowrap w-fit px-12 text-center text-4xl font-thin tracking-[3.5px]
        text-[#1e1e1e] sm:text-5xl">
            {{ __('LATEST NEWS') }}
        </h1>
        <div class="bg-gold my-5 h-[1px] w-[125px]"></div>
        <p class="text-md mb-14 max-w-[600px] px-12 text-center text-[#999999] sm:text-lg">
